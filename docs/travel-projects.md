...
- Phase 17 已在 Production 完成五份 additive migrations、5-record transactional copy 與完整 read-back；Media、TimelineEvents、HomeConfig 的新 polymorphic 影子關聯已填入，舊 records／關聯仍保留供 legacy runtime 使用。RLS／grants security migration 已完成本地演練但尚未套用 Production，因此 runtime 尚未 cutover。詳見 `docs/phase-artifacts/phase-17/travel-migration-data-copy-approval-package.md` 與 `docs/phase-artifacts/phase-17/travel-data-api-security-approval-package.md`。
