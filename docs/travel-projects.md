...
- Phase 17 已備妥五份 additive migrations 與 gated transactional copy CLI；Media、TimelineEvents、HomeConfig 使用新 polymorphic 影子關聯承接 copy，舊關聯保留到 runtime cutover 完成。Production 尚未執行 migration 或 data-copy，詳見 `docs/phase-artifacts/phase-17/travel-migration-data-copy-approval-package.md`。
