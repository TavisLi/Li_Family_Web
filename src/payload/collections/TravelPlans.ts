      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Itinerary day', value: 'itinerary-day' },
        ...
        { name: 'displayDay', type: 'number', required: false, min: 1 },
        { name: 'date', type: 'date', required: false },
        { name: 'subtitle', type: 'text', required: false, localized: true },
        ...
        mediaItemsField(),
        {
          ...
          fields: [
            ...
            { name: 'votingEnabled', type: 'checkbox', defaultValue: true, required: false },
          ],
        },
      ],
    },
