...
assert.ok(!memoryFieldNames.includes('dailyHighlights'))
assert.ok(memoryFieldNames.includes('galleryImages'))
assert.ok(memoryFieldNames.includes('externalVideos'))
